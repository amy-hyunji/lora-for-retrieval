...
def load_retriever(model_path, pooling="average", random_init=False, args=None):
    ...
    if args.lora:
        print(f"## Adding Lora!")
        retriever = PeftModel.from_pretrained(retriever, args.lora_path)
