...
def main(cfg: DictConfig):
    ...
    assert cfg.model_file, f"Please specify encoder checkpoint as model_file param: {cfg.model_file}"
    assert cfg.ctx_src, f"Please specify passages source as ctx_src param: {cfg:ctx_src}"
