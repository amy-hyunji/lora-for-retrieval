...
class BiEncoder(nn.Module):
    ...
    def load_state(self, saved_state: CheckpointState, strict: bool = True):
        ...
        if "question_model.base_model.model.embeddings.position_ids" in saved_state.model_dict:
           del saved_state.model_dict["question_model.base_model.model.embeddings.position_ids"]
           del saved_state.model_dict["ctx_model.base_model.model.embeddings.position_ids"]
        """
