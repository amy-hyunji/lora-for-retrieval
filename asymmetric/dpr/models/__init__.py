...
def init_hf_bert_adapter_biencoder(args, **kwargs):
    if importlib.util.find_spec("transformers") is None:
        raise RuntimeError("Please install transformers lib")
    from .t_hf_models import get_adapter_bert_biencoder_components

    return get_adapter_bert_biencoder_components(args, **kwargs)

def init_hf_bert_prefix_tuning_biencoder(args, **kwargs):
    if importlib.util.find_spec("transformers") is None:
        raise RuntimeError("Please install transformers lib")
    from .t_hf_models import get_prefix_tuning_bert_biencoder_components

    return get_prefix_tuning_bert_biencoder_components(args, **kwargs)
...
BIENCODER_INITIALIZERS = {
    ...
    "hf_adapter_bert": init_hf_bert_adapter_biencoder,
    "hf_prefix_tuning_bert": init_hf_bert_prefix_tuning_biencoder,
